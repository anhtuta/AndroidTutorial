package anhtu.bkhn.contentprovidertutorialspoint;
...
public class StudentsProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (rowID > 0) {
            ...
            getContext().getContentResolver().notifyChange(_uri, null);     //nếu insert thành công thì thông báo rằng đã insert đc để những thằng khác còn biết database đã đc thay đổi
            return _uri;
        }
