...
public class UpdateActivity extends AppCompatActivity {
    ...
    private void getNVInfo() {  //lấy thông tin của nv hiển thị lên activity_update
        ...
        id = intent.getIntExtra("ID", -1);  //lấy id của 1 nhân viên mà activity trước đó truyền cho (chính là của AdapterNhanVien truyền cho)

        SQLiteDatabase database = QLNVDatabase.initDatabase(this, DATABASE_NAME); //chọn database:
    ...
    private void updateInfo() {
        ...
        contentValues.put("Ten", txtTen.getText().toString());  //tham số 1 là tên cột trong bảng trong database, tham số thứ 2 là dữ liệu để update
        contentValues.put("SDT", txtSdt.getText().toString());
        contentValues.put("Anh", getByteArrayFromImageView(ivAnh));

        QLNVDatabase.updateDatabase(this, id, contentValues);
