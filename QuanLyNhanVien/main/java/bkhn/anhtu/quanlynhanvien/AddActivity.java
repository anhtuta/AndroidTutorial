...
public class AddActivity extends AppCompatActivity {
    ...
    private void insertNv() {
        ...
        contentValues.put("Ten", txtTen.getText().toString());  //tham số 1 là tên cột trong bảng trong database, tham số thứ 2 là dữ liệu để insert
        contentValues.put("SDT", txtSdt.getText().toString());
        contentValues.put("Anh", getByteArrayFromImageView(ivAnh));

        QLNVDatabase.insertDatabase(this, contentValues);
